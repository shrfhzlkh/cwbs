...
if(isset($_GET['date_book'])){
  $date = $_GET['date_book'];
  $stmt = $conn->prepare("select * from booking where Book_date = ?");
...
<body>
 ...
 <a type="submit" class="btn btn-custom my-2 mx-1" href="back.php?time=<?php echo $_GET['book_id']?>&id=<?php echo $_GET['id']?>" >Back</a>
 ...
 <div class="container-fluid pt-5 ">
	<div class="card shadow " style="width:83rem;" >
...
<input type="hidden"  name="date" value=<?php echo $_GET['date_book']?>>
...
<div class="row">
   <div class="col-md-12">
    ...
    <div class="col-md-2">
       ...
       <?php }else{ ?>
           <button class="btn btn-success book" name="time_slot" type="submit" value="<?php echo $ts; ?>"><?php echo $ts; ?></button>
           <?php }  ?>
        </div>
    </div>
    <?php } ?>
...
<div class="container pt-4">
			<div class="bg-image"></div>
                ...
                <button type="button" class="btn btn-success"></button> Available<br>
                <button type="button" class="btn btn-danger"></button> Not Available<br>
	</div>
	</div>
	</div>	
	</div>
