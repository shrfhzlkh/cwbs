				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>All Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT * from booking o  
                            join customer c ON o.Cust_id=c.Cust_id 
                            join service s ON o.Service_id=s.Service_id
                            join car p ON o.car_id=p.car_id order by o.Book_id DESC";
...
<td><a href="booking-details.php?bid=<?php echo htmlentities($result->Book_id);?>">View</a>
</td>
<?php } ?>
</tr>
						 <?php } else { ?>
