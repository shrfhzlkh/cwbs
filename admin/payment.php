...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Payment</li>
            </ol>
<div class="agile-grids">	
				...
				?>
					  ...
					  <h2>Payment List for <?php echo $date ?></h2>
					    <table id="table">
						<thead>
						  <tr>
						  <th>NO</th>
						...
						<tbody>
<?php 
$sql = "SELECT * from booking b join customer c on  b.Cust_id=c.Cust_id where b.Book_status='PAID' and b.Book_date between '$date' and '$date' order by b.Book_date";
$query = $dbh -> prepare($sql);
$query->execute();
